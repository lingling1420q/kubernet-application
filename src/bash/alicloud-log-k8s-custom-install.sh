...
if [ $installRst -eq 0 ]; then
    ...
    exit 0
fi[root@bje-shm-foundation-k8s-master-01 super]#
[root@bje-shm-foundation-k8s-master-01 super]#
[root@bje-shm-foundation-k8s-master-01 super]#
[root@bje-shm-foundation-k8s-master-01 super]#
[root@bje-shm-foundation-k8s-master-01 super]# cat alicloud-log-k8s-custom-install.sh
#!/bin/bash
